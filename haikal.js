...
let user = global.db.data.users[m.sender]
anjay(`
Hello Saya 𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"retailerId": `© 𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃WE ARE NOT MASTOD`,
...
user.afkReason = text
deploy(`${m.pushName} Hello Saya 𝙹𝚒𝚗𝚇 - 𝙱𝙾𝚃${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/asupan/ukhty?apikey=925b04ib0j`
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/asupan/santuy?apikey=925b04ib0j`
haikal.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Ini Kak Jangan Lupa Donasi Ya:)"}, {quoted:hw})
break
//=================================================//
case 'hijaber':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/asupan/hijaber?apikey=925b04ib0j`
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/indonesia?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-malaysia':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/malaysia?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-thai':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/thailand?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-vietnam':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/vietnam?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-korea':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/korea?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan-jepan':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/japan?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
case 'cecan':
...
if (!isRegistered) return replyReg(mess.verif)
teks = `nih Kak >\\<`
buffer = `https://fax-home.herokuapp.com/api/cecan/random?apikey=925b04ib0j`
haikal.sendMessage(from, {image:{url:buffer}, caption:"Done!"}, {quoted:hw})
break
//=================================================//
...
if (isBan) throw sticBanLu(from)
if (!isRegistered) return replyReg(mess.verif)
anjay('WhatsApp : wa.me/6281356484612\n\n Instagram : https://instagram.com/fbryaaannn')
}
break
//=================================================//
case 'chat': {
...
┣❏➥ Jangan SPAM BOT
┣❏➥ Jangan Telfon BOT
┣❏➥ BOT akan berhenti ketika owner mendapati fiture Error
┣❏➥ BOT akan update kalau owner melihat fiture yang Error
┣❏➥ Jangan lupa donasi untuk BOT
┣❏➥ BOT ini Free untuk kalian
┣❏➥ Kalau mau daftar jadi premium/owner chat nomor di bawah ini not free yee
-----------------------
contact me Wa.me/6281356484612
name owner : F B R Y A N
Base script ori : Amandaa Cute
Recode Base script : F B R Y A N
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Base Script
